package ktichenpos.table.ui;

import java.net.URI;
import java.util.List;
import ktichenpos.table.application.TableService;
import ktichenpos.table.dto.OrderTableRequest;
import ktichenpos.table.dto.OrderTableResponse;
