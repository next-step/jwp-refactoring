...
public class TableService {
    ...
    private final ChangeStateTableValidator changeOrderTableValidator;

    public TableService(final ChangeStateTableValidator changeOrderTableValidator, final OrderTableRepository orderTableRepository) {
