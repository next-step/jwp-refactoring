...
public class OrderAcceptanceTest extends AcceptanceTest {
	...
	public static void 주문_생성_검증(OrderResponse orderResponse) {
		assertThat(orderResponse.getOrderStatus()).isEqualTo(kitchenpos.order.OrderStatus.COOKING.name());
		assertThat(orderResponse.getOrderLineItems()).map(kitchenpos.order.dto.OrderLineItemResponse::getOrderId)
