...
import api.exception.table.IllegalOrderTableException;
import api.exception.tablegroup.NotSupportUngroupException;
import api.table.application.TableValidator;
...
public class TableGroupValidator {
    ...
    public void validateGroup(List<Long> tableIds) {
        ...
        if (orderTables.isEmpty() || orderTables.size() < TableGroup.MIN_NUMBER_TABLES) {
