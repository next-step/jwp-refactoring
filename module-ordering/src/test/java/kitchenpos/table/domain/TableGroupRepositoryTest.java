...
//        tableGroupRequest = TableGroupRequest.of(tableGroup1Id, tableGroup1OrderTables);
    ...
    void create() {
        ...
        Assertions.assertThat(persistTableGroup.getId()).isEqualTo(tableGroup1Id);
        Assertions.assertThat(persistTableGroup.getOrderTables()).contains(persistOrderTable1, persistOrderTable2);
    }
