...
public class OrderRestController {
    ...
    public ResponseEntity<OrderResponse> create(@RequestBody final OrdersRequest request) {
    ...
    public ResponseEntity<OrderResponse> changeOrderStatus(
            @PathVariable final Long orderId, @RequestBody final OrderStatusRequest request) {
