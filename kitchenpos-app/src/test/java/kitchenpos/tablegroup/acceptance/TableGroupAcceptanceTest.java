...
import kitchenpos.order.acceptance.OrderAcceptance;
...
public class TableGroupAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        비어있지_않은_주문_테이블2 = TableAcceptance.create_table(2, false).as(OrderTableResponse.class);
    ...
    void createTable() {
        ...
        TableGroupResponse response =
                TableGroupAcceptance.create_table_group(Arrays.asList(빈_주문_테이블1.getId(), 빈_주문_테이블2.getId()))
