...
public class ProductAcceptanceTest extends AcceptanceTest {
    ...
    void createProduct() {
        ...
        ExtractableResponse<Response> response =
                ProductAcceptance.create_product("스테이크", new BigDecimal(25000));
    ...
    void createProductWithNullName() {
        // when
        ExtractableResponse<Response> response =
                ProductAcceptance.create_product(null, new BigDecimal(25000));
    ...
    void list() {
        // given
        ProductAcceptance.create_product("스테이크", new BigDecimal(25000));
        ProductAcceptance.create_product("스파게티", new BigDecimal(18000));
