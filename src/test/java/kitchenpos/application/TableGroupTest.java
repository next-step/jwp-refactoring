...
////        세번째_주문_테이블 = new OrderTable(3L, 1L, 4, false);
//        우아한형제들_단체그룹 = new TableGroup(1L, null, Arrays.asList(첫번째_주문_테이블, 두번째_주문_테이블));
//        우테코5기_단체그룹 = new TableGroup(2L, null, Collections.singletonList(첫번째_주문_테이블));
//    }
//
...
//
//        // then
//        assertThat(두번째_주문_테이블.getTableGroup()).isNull();
//        assertThat(세번째_주문_테이블.getTableGroup()).isNull();
//    }
}
