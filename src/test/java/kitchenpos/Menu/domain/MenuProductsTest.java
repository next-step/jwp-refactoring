...
public class MenuProductsTest {
    ...
    @DisplayName("MenuProducts 항목을 추가한다")
    @Test
    void MenuProducts_항목_추가_테스트() {
        // given
        ...
        assertAll(
                ...
                () -> assertThat(menuProducts.getMenuProducts()).containsExactly(풀코스_카프레제샐러드, 풀코스_알리오올리오, 풀코스_쉬림프로제, 풀코스_레드와인)
        );
    }
