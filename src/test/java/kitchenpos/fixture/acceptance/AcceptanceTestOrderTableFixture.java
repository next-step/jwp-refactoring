...
public class AcceptanceTestOrderTableFixture {
    public final OrderTable 테이블1;
    public final OrderTable 테이블2;
    public final OrderTable 빈_테이블1;
    public final OrderTable 빈_테이블2;

    public AcceptanceTestOrderTableFixture() {
        테이블1 = TableAcceptanceTest.주문_테이블_생성_요청(4, false).as(OrderTable.class);
        테이블2 = TableAcceptanceTest.주문_테이블_생성_요청(2, false).as(OrderTable.class);
