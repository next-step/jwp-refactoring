...
import static kitchenpos.table.step.TableAcceptanceStep.테이블_목록_조회됨;
import static kitchenpos.table.step.TableAcceptanceStep.테이블_빈_상태_수정_요청;
import static kitchenpos.table.step.TableAcceptanceStep.테이블_빈_상태_수정됨;
import static kitchenpos.table.step.TableAcceptanceStep.테이블_생성_요청;
import static kitchenpos.table.step.TableAcceptanceStep.테이블_생성됨;
import static kitchenpos.table.step.TableAcceptanceStep.테이블_손님_수_수정_요청;
import static kitchenpos.table.step.TableAcceptanceStep.테이블_손님_수_수정됨;
