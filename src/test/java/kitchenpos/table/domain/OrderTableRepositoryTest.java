...
public class OrderTableRepositoryTest {
    ...
    void create() {
        ...
        assertThat(persistOrderTable.getId()).isEqualTo(orderTable1.getId());
        assertThat(persistOrderTable.getTableGroupId()).isEqualTo(orderTable1.getTableGroupId());
        assertThat(persistOrderTable.getNumberOfGuests()).isEqualTo(orderTable1.getNumberOfGuests());
        assertThat(persistOrderTable.isEmpty()).isEqualTo(orderTable1.isEmpty());
    }
