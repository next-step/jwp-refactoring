...
class OrderTest {
    ...
    void changeMeal_success() {
        Orders order = new Orders(new OrderTable(1L, new TableGroup(), numberOfGuests(), false), new OrderLineItems(Arrays.asList(new OrderLineItem(null, 1L, quantityOrderLineItemA()))));
        order.meal();
    ...
    void changeMeal_fail_completion() {
        Orders order = new Orders(new OrderTable(1L, new TableGroup(), numberOfGuests(), false), new OrderLineItems(Collections.singletonList(new OrderLineItem(null, 1L, quantityOrderLineItemA()))));
        order.complete();
