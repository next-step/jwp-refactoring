...
public class OrderTest {
    ...
    void create_Fail_01() {
        ...
        // When & Then
        assertThatThrownBy(() -> new Order(주문테이블, 비어있는_주문_항목_목록))
    ...
    void create_Fail_02() {
        ...
        // When & Then
        assertThatThrownBy(() -> new Order(주문테이블, 주문_항목_목록))
            .isInstanceOf(CannotOrderException.class);
    }
    ...
    void changeOrderStatus_Fail() {
        // Given
        Order order = new Order(1L, 주문테이블, OrderStatus.COMPLETION, LocalDateTime.now(), 주문_항목_목록);
