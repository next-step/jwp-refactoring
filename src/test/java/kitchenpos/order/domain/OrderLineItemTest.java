...
class OrderLineItemTest {
    ...
    void 주문이_존재하지_않으면_주문_상품을_생성할_수_없다() {
        assertThatIllegalArgumentException()
                ...
                .withMessage(OrderLineItemErrorMessage.REQUIRED_ORDER.getMessage());
    }
    ...
    void 메뉴가_존재하지_않으면_주문_상품을_생성할_수_없다() {
        assertThatIllegalArgumentException()
                ...
                .withMessage(OrderLineItemErrorMessage.REQUIRED_MENU.getMessage());
    }
    ...
    void 수량이_음수이면_주문_상품을_생성할_수_없다() {
        assertThatIllegalArgumentException()
                ...
                .withMessage(OrderLineItemErrorMessage.INVALID_QUANTITY.getMessage());
    }
}
