...
public class OrderLineItemTestFixture {
    public static final OrderLineItem 짜장_탕수육_주문_항목 = orderLineItem(1L,  짜장_탕수육_세트, 1L);
    public static final OrderLineItem 짬뽕2_탕수육_주문_항목 = orderLineItem(2L, 짬뽕2_탕수육_세트, 2L);
    ...
    public static OrderLineItem orderLineItem(Long seq, Menu menu, long quantity) {
