...
class OrderAcceptanceTest extends AcceptanceTest {
    ...
    void changeOrderStatusFail() {
        OrderRequest notRegisteredOrder = OrderRequest.from(OrderStatus.MEAL);
    ...
    void changeOrderStatusFail2() {
        ...
        OrderResponse payedOrder = 주문_상태_변경_요청(registeredOrder.getId(), OrderRequest.from(OrderStatus.COMPLETION))
                .as(OrderResponse.class);

        ExtractableResponse<Response> response =
                주문_상태_변경_요청(payedOrder.getId(), OrderRequest.from(OrderStatus.MEAL));
