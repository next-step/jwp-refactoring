...
import static kitchenpos.menu.acceptance.MenuAcceptanceTest.치킨세트_메뉴_등록함;
import static kitchenpos.table.acceptance.TableAcceptanceTest.주문_테이블_등록됨;
...
class OrderAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        주문_테이블_response = 주문_테이블_등록됨(TestFixture.주문_테이블_REQUEST_FIXTURE);
