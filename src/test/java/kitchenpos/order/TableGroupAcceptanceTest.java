...
import static kitchenpos.order.step.TableGroupAcceptanceStep.단체_지정_되어_있음;
import static kitchenpos.order.step.TableGroupAcceptanceStep.단체_지정_됨;
import static kitchenpos.order.step.TableGroupAcceptanceStep.단체_지정_요청;
import static kitchenpos.order.step.TableGroupAcceptanceStep.단체_해제_됨;
import static kitchenpos.order.step.TableGroupAcceptanceStep.단체_해제_요청;
