...
class MenuValidatorTest {
    ...
    void checkValidPrice_fail_menuPriceGe() {
        ...
        given(productRepository.findById(productId1))
                .willReturn(Optional.of(상품_데이터_생성(productId1, "product1", BigDecimal.valueOf(300)))); // 300 * 2 = 600
        given(productRepository.findById(productId2))
                .willReturn(Optional.of(상품_데이터_생성(productId2, "product2", BigDecimal.valueOf(400)))); // 400 * 1 = 300
