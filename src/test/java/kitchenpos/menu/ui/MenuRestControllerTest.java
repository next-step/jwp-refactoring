...
public class MenuRestControllerTest extends RestControllerTest<MenuRequest> {
    ...
    private static final MenuProduct 치즈버거세트_치즈버거 = new MenuProduct(1L, 치즈버거.getId(), 1L);
    private static final MenuProduct 치즈버거세트_감자튀김 = new MenuProduct(1L, 감자튀김.getId(), 1L);
    private static final MenuProduct 치즈버거세트_콜라 = new MenuProduct(1L, 콜라.getId(), 1L);
