...
class MenuGroupAcceptanceTest extends AcceptanceTest {
	...
	private MenuGroup 두마리메뉴_그룹_생성_요청값;
	private MenuGroup 한마리메뉴_그룹_생성_요청값;
	...
	void 메뉴_그룹_목록을_조회한다() {
		// given
		MenuGroup 두마리_메뉴_그룹_생성_되어있음 = 메뉴_그룹_생성되어_있음(두마리메뉴_그룹_생성_요청값);
		MenuGroup 한마리_메뉴_그룹_생성_되어있음 = 메뉴_그룹_생성되어_있음(한마리메뉴_그룹_생성_요청값);
