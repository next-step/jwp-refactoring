...
class MenuTest {
	...
	public void createMenuTest() {
		//when
		Menu menu = new Menu(1L, "신양념", Price.valueOf(new BigDecimal(20000)), menuGroup,menuProducts );
	...
	public void crateMenuFailPriceLessThanZeroTest() {
		assertThatThrownBy(
			() -> new Menu(1L, "신양념", Price.valueOf(new BigDecimal(-1)), menuGroup, menuProducts))
	...
	public void crateMenuFailPriceLessThanProductsPriceSumTest() {
		assertThatThrownBy(
			() -> new Menu(1L, "신양념", Price.valueOf(new BigDecimal(50000)), menuGroup, menuProducts))
			.isInstanceOf(IllegalArgumentException.class)
