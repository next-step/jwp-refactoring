...
class MenuTest {
	...
	public void createMenuTest() {
		//when
		Menu menu = new Menu(1L,"신양념", Price.valueOf(new BigDecimal(20000)), menuGroup, Lists.newArrayList(menuProduct));
	...
	public void crateMenuFailPriceLessThanZeroTest() {
		assertThatThrownBy(
			() -> new Menu(1L, "신양념", Price.valueOf(new BigDecimal(-1)), menuGroup, Lists.newArrayList(menuProduct)))
	...
	public void crateMenuFailPriceLessThanProductsPriceSumTest() {
		assertThatThrownBy(
			() -> new Menu(1L, "신양념", Price.valueOf(new BigDecimal(50000)), menuGroup, Lists.newArrayList(menuProduct)))
			.isInstanceOf(IllegalArgumentException.class)
