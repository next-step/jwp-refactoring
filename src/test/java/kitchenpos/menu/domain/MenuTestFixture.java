...
public class MenuTestFixture {
    ...
    public static MenuRequest 짬뽕2_탕수육_세트_요청 = menuRequest(
            "짬뽕2_탕수육_세트", BigDecimal.valueOf(30_000L), 3L, 짬뽕_2그릇_요청, 탕수육_소_1그릇_요청);
    public static Menu 짜장_탕수육_세트 = menu("짜장_탕수육_세트", BigDecimal.valueOf(25_000L), 세트류, 짜장면_1그릇, 탕수육_소_1그릇);
    public static Menu 짬뽕2_탕수육_세트 = menu("짬뽕2_탕수육_세트", BigDecimal.valueOf(30_000L), 세트류, 짬뽕_2그릇, 탕수육_소_1그릇);
