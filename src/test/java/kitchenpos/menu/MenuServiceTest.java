...
public class MenuServiceTest {
    ...
    void setUp() {
        ...
        중국음식 = 메뉴_그룹_등록("중국음식");
        짜장면메뉴 = 메뉴_등록("짜장면탕수육세트", 짜장면.getPrice().add(탕수육.getPrice()), 중국음식, Arrays.asList(메뉴_상품_등록(짜장면, 1L), 메뉴_상품_등록(탕수육, 1L)));
    ...
    public static Menu 메뉴_등록(String name, BigDecimal price, MenuGroup menuGroup, List<MenuProduct> menuProducts) {
