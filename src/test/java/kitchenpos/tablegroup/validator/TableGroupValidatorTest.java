...
class TableGroupValidatorTest {
    ...
    void 등록_된_주문_테이블에_대해서만_단체_지정이_가능하다() {
        ...
        ThrowingCallable 등록되지_않은_주문_테이블_단체_지정할_경우 = () -> tableGroupValidator.validateCreation(1L, null);
    ...
    void 비어있지_않은_주문_테이블은_단체_지정을_할_수_없다() {
        ...
        ThrowingCallable 비어있지_않은_주문_테이블_단체_지정할_경우 = () -> tableGroupValidator.validateCreation(1L, null);
    ...
    void 이미_단체_지정이_된_주문_테이블은_단체_지정을_할_수_없다() {
        ...
        ThrowingCallable 이미_단체_지정이_된_주문_테이블_단체_지정할_경우 = () -> tableGroupValidator.validateCreation(1L, null);
    ...
    void 최소_2개_이상의_주문_테이블들에_대해서만_단체_지정_가능하다() {
        ...
        ThrowingCallable 주문_테이블을_1개만_지정한_경우 = () -> tableGroupValidator.validateCreation(1L, null);
