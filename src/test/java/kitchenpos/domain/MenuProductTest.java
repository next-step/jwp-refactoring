...
public class MenuProductTest {
    public static MenuProduct MP1후라이드 = new MenuProduct(후라이드, 1);
    public static MenuProduct MP2양념치킨 = new MenuProduct(양념치킨, 1);
    public static MenuProduct MP3반반치킨 = new MenuProduct(반반치킨, 1);
    public static MenuProduct MP4통구이 = new MenuProduct(통구이, 1);
    public static MenuProduct MP5간장치킨 = new MenuProduct(간장치킨, 1);
    public static MenuProduct MP6순살치킨 = new MenuProduct(순살치킨, 1);
