...
class ProductAcceptanceTest extends AcceptanceTest {
	...
	void 상품을_생성한다() {
		// given
		Product 후라이드_치킨_생성_요청값 = 상품_요청값_생성("후라이드", 16000);
	...
	void 상품의_가격이_0이하_일때_생성에_실패한다() {
		// given
		Product 가격이_0이하인_치킨_생성_요청값 = 상품_요청값_생성("후라이드", -1000);
	...
	void 상품의_가격이_없으면_생성에_실패한다() {
		// given
		Product 가격이_없는_치킨_생성_요청값 = 상품_요청값_생성("후라이드", null);
	...
	void 상품_목록을_조회한다() {
		// given
		Product 파닭_생성_요청값 = 상품_요청값_생성("파닭", 16000);
		Product 불닭_생성_요청값 = 상품_요청값_생성("불닭", 16000);

		Product 파닭 = 상품이_생성_되어있음(파닭_생성_요청값);
		Product 불닭 = 상품이_생성_되어있음(불닭_생성_요청값);
