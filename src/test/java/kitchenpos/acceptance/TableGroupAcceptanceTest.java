...
//                Product.of(1L, "후라이드", BigDecimal.valueOf(18000))
//        ).as(Product.class);
//
//        // And 메뉴 등록되어 있음
//        List<MenuProduct> 메뉴상품목록 = Arrays.asList(MenuProduct.of(1L, 1L, 후라이드.getId(), 2));
//        Menu 허니콤보 = 메뉴_등록되어_있음(
//                Menu.of(1L, "허니콤보", BigDecimal.valueOf(18000), 두마리메뉴.getId(), 메뉴상품목록)
//        ).as(Menu.class);
//
//        // And 주문 테이블 여러개 등록되어 있음
...
//
//        // And 주문(조리) 등록되어 있음
//        List<OrderLineItem> 주문항목 = Arrays.asList(OrderLineItem.of(허니콤보.getId(), 2));
//        주문_등록되어_있음(Order.of(등록된_주문_테이블1.getId(), 주문항목)).as(Order.class);
//        주문_등록되어_있음(Order.of(등록된_주문_테이블2.getId(), 주문항목)).as(Order.class);
//
//        // When 단체 지정 취소 요청함
