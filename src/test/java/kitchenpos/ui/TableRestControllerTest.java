...
class TableRestControllerTest extends IntegrationTest {
	...
	void create() throws Exception {
		...
		OrderTable savedTableOrder = objectMapper.readValue(response.getContentAsString(), OrderTable.class);
	...
	void changeEmpty() throws Exception {
		...
		MockHttpServletResponse response = mockMvc.perform(
			put(BASE_PATH + "/{orderTableId}/empty", expectedOrderTable.getTableGroupId())
				.contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(params))
		).andReturn().getResponse();
	...
	void changeNumberOfGuests() throws Exception {
		...
		//when
		MockHttpServletResponse response = mockMvc.perform(
			put(BASE_PATH + "/{numberOfGuests}/number-of-guests", expectedOrderTable.getNumberOfGuests())
				.contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(params))
		).andReturn().getResponse();
