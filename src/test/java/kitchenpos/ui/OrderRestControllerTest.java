...
public class OrderRestControllerTest {
    ...
    public void setUp() {
        ...
        Product 후라이드치킨_상품 = Product.of(1L, "후라이드치킨", BigDecimal.valueOf(16_000L));
        Product 콜라_상품 = Product.of(2L, "콜라", BigDecimal.valueOf(2_000L));
        Menu 후라이드치킨_메뉴 = Menu.of(1L, "후라이드치킨", 후라이드치킨_상품.getPrice(), 한마리메뉴_메뉴그룹.getId());
        Menu 콜라_메뉴 = Menu.of(2L, "콜라", 콜라_상품.getPrice(), 한마리메뉴_메뉴그룹.getId());
