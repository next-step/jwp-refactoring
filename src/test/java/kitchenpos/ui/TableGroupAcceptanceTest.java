...
import static kitchenpos.ui.OrderAcceptanceTest.주문_생성_요청;
...
class TableGroupAcceptanceTest extends AcceptanceTest {
    ...
    void createTableGroupException() {
        ...
        ExtractableResponse<Response> response = 단체_지정_생성_요청(tableGroup);
    ...
    private static ExtractableResponse<Response> 단체_지정_생성_요청(TableGroup tableGroup) {
        return RestAssured
                .given().log().all()
