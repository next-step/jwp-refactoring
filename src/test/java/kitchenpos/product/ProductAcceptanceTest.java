...
public class ProductAcceptanceTest extends AcceptanceTest {
	...
	void register() {
		// when
		ExtractableResponse<Response> response = 상품_등록_요청(강정치킨());
	...
	void registerFailOnNegativePrice() {
		// when
		ExtractableResponse<Response> response = 상품_등록_요청(음수가격상품());
	...
	void registerFailOnEmptyName() {
		// when
		ExtractableResponse<Response> response = 상품_등록_요청(이름없는상품());
	...
	void findAll() {
		// given
		ProductDto 강정치킨_상품 = 상품_등록되어_있음(강정치킨()).as(ProductDto.class);
		ProductDto 양념치킨_상품 = 상품_등록되어_있음(양념치킨()).as(ProductDto.class);
	...
	private ExtractableResponse<Response> 상품_등록되어_있음(ProductCreateRequest request) {
