...
public class OrderRestController {
    ...
    public ResponseEntity<OrderResponse> create(@RequestBody final CreateOrderRequest createOrderRequest) {
        final OrderResponse created = orderService.create(createOrderRequest);
