...
public class TableRestController {
    ...
    public ResponseEntity<OrderTableResponse> changeEmpty(
        ...
        return ResponseEntity.ok()
                .body(OrderTableResponse.of(tableService.changeEmpty(orderTableId, orderTableRequest)))
                ;
    }
    ...
    public ResponseEntity<OrderTableResponse> changeNumberOfGuests(
        ...
        return ResponseEntity.ok()
                .body(OrderTableResponse.of(tableService.changeNumberOfGuests(orderTableId, orderTableRequest)))
                ;
    }
}
