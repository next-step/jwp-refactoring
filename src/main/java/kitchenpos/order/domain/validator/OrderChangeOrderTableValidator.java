...
import kitchenpos.ordertable.domain.validator.ChangeOrderTableValidator;
...
@Component
public class OrderChangeOrderTableValidator implements ChangeOrderTableValidator {
    ...
    public OrderChangeOrderTableValidator(OrderRepository orderRepository) {
