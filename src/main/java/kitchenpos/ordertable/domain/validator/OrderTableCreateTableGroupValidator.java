...
@Component
public class OrderTableCreateTableGroupValidator implements CreateTableGroupValidator {
    ...
    public OrderTableCreateTableGroupValidator(OrderTableRepository orderTableRepository) {
