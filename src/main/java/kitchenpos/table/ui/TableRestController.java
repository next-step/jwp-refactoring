package kitchenpos.domain.table.ui;

import java.net.URI;
import java.util.List;
import kitchenpos.domain.table.application.TableService;
...
public class TableRestController {
    ...
    public ResponseEntity<OrderTableResponse> changeEmpty(
        ...
        return ResponseEntity.ok()
            .body(tableService.changeEmpty(orderTableId, orderTable.toEntity()));
    }
    ...
    public ResponseEntity<OrderTableResponse> changeNumberOfGuests(
        ...
        return ResponseEntity.ok()
            .body(tableService.changeNumberOfGuests(orderTableId, orderTable.toEntity()));
    }
}
