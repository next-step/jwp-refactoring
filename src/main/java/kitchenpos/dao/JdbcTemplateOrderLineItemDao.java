...
public class JdbcTemplateOrderLineItemDao implements OrderLineItemDao {
    ...
    @Override
    public OrderLineItemRequest save(final OrderLineItemRequest entity) {
    ...
    @Override
    public Optional<OrderLineItemRequest> findById(final Long id) {
        try {
    ...
    @Override
    public List<OrderLineItemRequest> findAll() {
        final String sql = "SELECT seq, order_id, menu_id, quantity FROM order_line_item";
        return jdbcTemplate.query(sql, (resultSet, rowNumber) -> toEntity(resultSet));
    }

    @Override
    public List<OrderLineItemRequest> findAllByOrderId(final Long orderId) {
    ...
    private OrderLineItemRequest select(final Long id) {
    ...
    private OrderLineItemRequest toEntity(final ResultSet resultSet) throws SQLException {
        final OrderLineItemRequest entity = new OrderLineItemRequest();
