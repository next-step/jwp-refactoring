...
public class JdbcTemplateOrderLineItemDao implements OrderLineItemDao {
    ...
    private OrderLineItem toEntity(final ResultSet resultSet) throws SQLException {
        final OrderLineItem entity = new OrderLineItem(resultSet.getLong(KEY_COLUMN_NAME),
                resultSet.getLong("order_id"), resultSet.getLong("menu_id"), resultSet.getLong("quantity"));
        return entity;
    }
}
