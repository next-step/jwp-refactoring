...
public class JdbcTemplateMenuProductDao implements MenuProductDao {
    ...
    @Override
    public MenuProductRequest save(final MenuProductRequest entity) {
    ...
    @Override
    public Optional<MenuProductRequest> findById(final Long id) {
        try {
    ...
    @Override
    public List<MenuProductRequest> findAll() {
        final String sql = "SELECT seq, menu_id, product_id, quantity FROM menu_product";
        return jdbcTemplate.query(sql, (resultSet, rowNumber) -> toEntity(resultSet));
    }

    @Override
    public List<MenuProductRequest> findAllByMenuId(final Long menuId) {
    ...
    private MenuProductRequest select(final Long id) {
    ...
    private MenuProductRequest toEntity(final ResultSet resultSet) throws SQLException {
        final MenuProductRequest entity = new MenuProductRequest();
