...
public class JdbcTemplateOrderTableDao implements OrderTableRepository {
    ...
    @Override
    public OrderTableRequest save(final OrderTableRequest entity) {
    ...
    @Override
    public Optional<OrderTableRequest> findById(final Long id) {
        try {
    ...
    @Override
    public List<OrderTableRequest> findAllByIdIn(final List<Long> ids) {
    ...
    @Override
    public List<OrderTableRequest> findAllByTableGroupId(final Long tableGroupId) {
    ...
    private OrderTableRequest select(final Long id) {
    ...
    private void update(final OrderTableRequest entity) {
    ...
    private OrderTableRequest toEntity(final ResultSet resultSet) throws SQLException {
        final OrderTableRequest entity = new OrderTableRequest();
