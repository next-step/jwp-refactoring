...
public class JdbcTemplateMenuDao implements MenuRepository {
    ...
    @Override
    public MenuRequest save(final MenuRequest entity) {
    ...
    @Override
    public Optional<MenuRequest> findById(final Long id) {
        try {
    ...
    @Override
    public List<MenuRequest> findAll() {
    ...
    private MenuRequest select(final Long id) {
    ...
    private MenuRequest toEntity(final ResultSet resultSet) throws SQLException {
        final MenuRequest entity = new MenuRequest();
