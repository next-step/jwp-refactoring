...
public class ErrorMessage {
    ...
    public static final String INVALID_QUANTITY = "수량은 널이거나 1보다 작을 수 없습니다";
    public static final String INVALID_NAME = "이름은 널이거나 공백일 수 없습니다";
    public static final String INVALID_SUM_OF_PRICE = "메뉴 가격은 메뉴상품들의 총 가격합보다 작아야 합니다";
