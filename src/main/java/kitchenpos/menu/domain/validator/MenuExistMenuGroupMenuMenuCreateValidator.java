...
@Component
public class MenuExistMenuGroupMenuMenuCreateValidator implements MenuGroupMenuCreateValidator {
    private static final String NOT_FOUND_ERROR_MESSAGE = "메뉴 그룹을 찾지 못하였습니다.";
    private final MenuGroupRepository menuGroupRepository;

    public MenuExistMenuGroupMenuMenuCreateValidator(MenuGroupRepository menuGroupRepository) {
