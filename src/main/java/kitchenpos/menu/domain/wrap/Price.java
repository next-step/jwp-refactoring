package kitchenpos.menu.domain.wrap;
...
public class Price {
    ...
    public static Price of(BigDecimal price, BigDecimal menuProductsTotalMenuProductPrice) {
        return new Price(price, menuProductsTotalMenuProductPrice);
    }

    private void validateMenuPrice(BigDecimal price, BigDecimal menuProductsTotalMenuProductPrice) {
        validatePriceIsZero(price);
        validateMenuPriceIsOverThanTotalMenuProductsPrice(price, menuProductsTotalMenuProductPrice);
    }

    private static void validatePriceIsZero(BigDecimal price) {
    ...
    private void validateMenuPriceIsOverThanTotalMenuProductsPrice(BigDecimal price,
        BigDecimal menuProductsTotalMenuProductPrice) {
