...
public enum ErrorCode {
    ...
    ORDER_TABLE_IS_EMPTY("주문 테이블이 빈 상태입니다."),
    ALREADY_TABLE_GROUP("이미 단체그룹으로 지정되어 있습니다."),
    NAME_SHOULD_NOT_EMPTY("이름은 값이 존재해야 합니다."),
    PRICE_SHOULD_NOT_NULL("가격은 null 일 수 없습니다."),
    PRICE_SHOULD_OVER_ZERO("가격은 0 이상이어야 합니다."),
    QUANTITY_SHOULD_OVER_ZERO("수량은 0보다 작을 수 없습니다."),
    MENU_PRICE_SHOULD_NOT_OVER_TOTAL_PRICE("메뉴의 가격이 전체 메뉴 상품 가격의 합보다 클 수 없습니다."),
    ORDER_TABLES_IS_EMPTY("주문 테이블 목록에 주문 테이블이 없습니다."),
    ORDER_TABLES_IS_NOT_EMPTY("빈 상태가 아닌 주문테이블이 존재합니다."),
