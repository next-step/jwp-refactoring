...
class TableServiceTest {
    ...
    void createTest() {
        ...
        // when
        OrderTableResponse createdOrderTable = tableService.create(OrderTableRequest.from(orderTable));
    ...
    void getListTest() {
        ...
        // then
        assertThat(orderTables).contains(OrderTableResponse.from(orderTable));
    }
    ...
    void changeEmptyTest() {
        ...
        TableService tableService = new TableService(orderTableRepository, eventPublisher);
        // when
        OrderTableResponse changedOrderTable = tableService.changeEmpty(orderTableId, OrderTableRequest.from(savedOrderTable));
    ...
    void changeNumberOfGuests(){
        ...
        // when
        OrderTableResponse changedOrderTable = tableService.changeNumberOfGuests(orderTableId, OrderTableRequest.from(orderTable));
