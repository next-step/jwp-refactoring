...
public class MenuProductTestFixture {
    ...
    public static MenuProduct 짜장면메뉴상품() {
        return MenuProduct.of(ProductTestFixture.상품생성(ProductTestFixture.짜장면요청()), 1L);
    }

    public static MenuProduct 짬뽕메뉴상품() {
        return MenuProduct.of(ProductTestFixture.상품생성(ProductTestFixture.짬뽕요청()), 1L);
    }

    public static MenuProduct 단무지메뉴상품() {
        return MenuProduct.of(ProductTestFixture.상품생성(ProductTestFixture.단무지요청()), 1L);
    }

    public static MenuProduct 탕수육메뉴상품() {
        return MenuProduct.of(ProductTestFixture.상품생성(ProductTestFixture.탕수육요청()), 1L);
    }
