...
class MenuServiceTest {
    ...
    @Mock
    private kitchenpos.menu.domain.ProductRepository ProductRepository;
    ...
    void createTest() {
        ...
        // then
        Assertions.assertThat(createdMenu.getId()).isEqualTo(강정치킨plus강정치킨.getId());
        Assertions.assertThat(createdMenu.getName()).isEqualTo(강정치킨plus강정치킨.getName());
        Assertions.assertThat(createdMenu.getPrice()).isEqualTo(강정치킨plus강정치킨.valueOfPrice());
        Assertions.assertThat(createdMenu.getMenuGroupId()).isEqualTo(강정치킨plus강정치킨.getMenuGroupId());
    }
    ...
    void listTest() {
        ...
        Assertions.assertThat(menus.get(0).getId()).isEqualTo(강정치킨plus강정치킨.getId());
        Assertions.assertThat(menus.get(0).getName()).isEqualTo(강정치킨plus강정치킨.getName());
        Assertions.assertThat(menus.get(0).getPrice()).isEqualTo(강정치킨plus강정치킨.valueOfPrice());
        Assertions.assertThat(menus.get(0).getMenuGroupId()).isEqualTo(강정치킨plus강정치킨.getMenuGroupId());
        Assertions.assertThat(menus.get(0).getMenuProducts().size()).isEqualTo(강정치킨plus강정치킨.sizeOfMenuProducts());
    }
}
