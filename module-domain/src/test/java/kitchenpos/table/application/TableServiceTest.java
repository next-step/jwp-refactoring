...
import kitchenpos.exception.FailedChangeEmptyException;
...
class TableServiceTest {
    ...
    void createTest() {
        ...
        // then
        Assertions.assertThat(createdOrderTable.getId()).isEqualTo(orderTable1.getId());
        Assertions.assertThat(createdOrderTable.getNumberOfGuests()).isEqualTo(orderTable1.getNumberOfGuests());
        Assertions.assertThat(createdOrderTable.isEmpty()).isEqualTo(orderTable1.isEmpty());
    }
    ...
    void changeNumberOfGuestsTest() {
        ...
        // then
        Assertions.assertThat(changedOrderTable.getNumberOfGuests()).isEqualTo(orderTable1.getNumberOfGuests());
    }
