...
public class MenuRestControllerTest extends RestControllerTest<MenuRequest> {
    ...
    private static final MenuProduct 치즈버거세트_치즈버거 = new MenuProduct(1L, 치즈버거_ID, 1L);
    private static final MenuProduct 치즈버거세트_감자튀김 = new MenuProduct(1L, 감자튀김_ID, 1L);
    private static final MenuProduct 치즈버거세트_콜라 = new MenuProduct(1L, 콜라_ID, 1L);
