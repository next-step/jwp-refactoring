...
class MenuAcceptanceTest extends BaseAcceptanceTest {
    ...
    private ResultActions 메뉴_목록_조회() throws Exception {
        return mvc.perform(MockMvcRequestBuilders.get("/api/menus")
    ...
    private void 메뉴_목록조회_성공(ResultActions resultActions, MenuRequest menu) throws Exception {
        ...
        resultActions.andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].id").value(menu.getId()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].name").value(menu.getName()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].price").value(menu.getPrice().floatValue()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].menuGroupId").value(menu.getMenuGroupId()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].menuProducts[0].seq").value(menuProducts.getSeq()))
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.[0].menuProducts[0].menuId").value(menuProducts.getMenuId()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].menuProducts[0].productId")
                        .value(menuProducts.getProductId()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].menuProducts[0].quantity")
                        .value(menuProducts.getQuantity()))
        ;
    }
    ...
    private void 메뉴_등록_성공(ResultActions resultActions, MenuRequest menu) throws Exception {
        ...
        resultActions.andExpect(MockMvcResultMatchers.status().isCreated())
                .andExpect(MockMvcResultMatchers.jsonPath("id").value(menu.getId()))
                .andExpect(MockMvcResultMatchers.jsonPath("name").value(menu.getName()))
                .andExpect(MockMvcResultMatchers.jsonPath("price").value(menu.getPrice().floatValue()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.menuProducts[0].seq").value(menuProduct.getSeq()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.menuProducts[0].menuId").value(menuProduct.getMenuId()))
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.menuProducts[0].productId").value(menuProduct.getProductId()))
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.menuProducts[0].quantity").value(menuProduct.getQuantity()))
        ;
    }
