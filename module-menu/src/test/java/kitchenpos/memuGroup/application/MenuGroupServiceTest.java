package kitchenpos.memuGroup.application;

import kitchenpos.TestMenuGroupFactory;
import kitchenpos.TestMenuGroupRequestFactory;
...
class MenuGroupServiceTest {
    ...
    void list() {
        ...
        //then
        Assertions.assertThat(results).containsExactly(MenuGroupResponse.of(분식류), MenuGroupResponse.of(양식류));
    }
