...
import kitchenpos.common.exception.CustomErrorResponse;
...
public class TableGroupAcceptanceTest extends AcceptanceTest {
    ...
    public static ExtractableResponse<Response> 단체지정_요청(TableGroupRequest tableGroupRequest) {
        return AcceptanceTest.post("/api/table-groups/", tableGroupRequest);
    }

    public static ExtractableResponse<Response> 단체지정_해제_요청(Long id) {
        return AcceptanceTest.delete("/api/table-groups/" + id);
    }
