...
import kitchenpos.MenuAcceptanceTest;
import kitchenpos.OrderAcceptanceTest;
...
class TableGroupAcceptanceTest extends OrderAcceptanceTest {
    ...
    Stream<DynamicNode> tableGroupAcceptance() {
        return Stream.of(
                ...
                dynamicTest("단체 테이블 해제시 조리 중이거나 식사중인 테이블은 해제할 수 없다.", () -> {
                    주문_등록되어_있음(테이블.getId(), Collections.singletonList(
