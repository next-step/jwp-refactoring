...
public class OrderTableTest {
    ...
    void ungroupOrderTable() {
        ...
        assertAll(
                ...
                () -> Assertions.assertThat(주문테이블A.hasTableGroup()).isTrue(),
                () -> Assertions.assertThat(주문테이블B.hasTableGroup()).isFalse()
        );
    }
    ...
    void updateTableGroupMakeOrderTableNotEmpty() {
        ...
        // then
        assertAll(
                () -> Assertions.assertThat(주문테이블A.isEmpty()).isFalse(),
                () -> Assertions.assertThat(주문테이블B.isEmpty()).isFalse()
        );
    }
