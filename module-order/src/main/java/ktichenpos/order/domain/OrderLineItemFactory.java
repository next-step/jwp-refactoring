...
import ktichenpos.order.exception.CannotMakeOrderException;
...
public class OrderLineItemFactory {
    ...
    public OrderLineItem createOrderLineItem(Long menuId, long quantity) {
        Menu menu = menuRepository.findById(menuId).orElseThrow(() -> new CannotMakeOrderException(
                CannotMakeOrderException.NOT_EXIST_MENU));
