...
import kitchenpos.order.exception.KitchenPosOrderException;
...
public class OrderRestController {
    ...
    @ExceptionHandler(KitchenPosOrderException.class)
    public ResponseEntity handleKitchenPosArgException(KitchenPosOrderException e) {
