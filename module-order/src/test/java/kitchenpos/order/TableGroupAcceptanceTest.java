...
import static kitchenpos.order.TableAcceptanceTest.주문테이블_목록_조회_요청;
import static kitchenpos.order.TableAcceptanceTest.주문테이블_목록_조회됨;
import static kitchenpos.order.application.TableServiceTest.두명;
import static kitchenpos.order.application.TableServiceTest.비어있음;
import static kitchenpos.order.application.TableServiceTest.세명;
import static kitchenpos.order.ui.TableGroupRestControllerTest.BASE_URL;
