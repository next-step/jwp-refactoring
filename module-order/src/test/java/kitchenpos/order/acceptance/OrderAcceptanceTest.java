...
import static acceptance.MenuAcceptanceMethods.메뉴_등록되어_있음;
import static acceptance.MenuGroupAcceptanceMethods.메뉴그룹_등록되어_있음;
...
public class OrderAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        테이블1_table = 테이블_등록되어_있음(4, false).as(OrderTableResponse.class);
        테이블2_table = 테이블_등록되어_있음(3, false).as(OrderTableResponse.class);
    ...
    void 주문_관리_비정상_시나리오() {
        ...
        OrderTableResponse 비어있는_테이블 = 테이블_등록되어_있음(0, true).as(OrderTableResponse.class);
