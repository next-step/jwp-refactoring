package kitchenpos.core.product.validator;

import kitchenpos.core.menu.domain.Menu;
import kitchenpos.core.menu.domain.MenuProductGroup;
import kitchenpos.core.menu.exception.IllegalMenuPriceException;
