...
import static api.menu.fixtures.MenuFixtures.후라이드두마리메뉴요청;
import static api.menu.fixtures.MenuFixtures.후라이드반양념반메뉴요청;
import static api.menugroup.fixtures.MenuGroupFixtures.*;
import static api.menu.fixtures.MenuProductFixtures.메뉴상품등록요청;
import static api.product.fixtures.ProductFixtures.*;
