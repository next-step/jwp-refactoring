...
import static api.menugroup.fixtures.MenuGroupFixtures.메뉴그룹;
import static api.order.fixtures.OrderFixtures.식사중으로_변경요청;
import static api.order.fixtures.OrderFixtures.주문등록요청;
import static api.table.fixtures.OrderTableFixtures.주문가능_다섯명테이블;
import static api.product.fixtures.ProductFixtures.양념치킨;
import static api.product.fixtures.ProductFixtures.후라이드;
