...
import static api.order.fixtures.OrderFixtures.*;
import static api.order.fixtures.OrderLineItemFixtures.주문정보_등록요청;
import static api.table.fixtures.OrderTableFixtures.주문가능_다섯명테이블요청;
import static api.table.fixtures.OrderTableFixtures.주문불가_다섯명테이블요청;
