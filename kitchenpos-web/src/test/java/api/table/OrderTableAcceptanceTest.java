...
import api.AcceptanceTest;
import api.menugroup.dto.MenuGroupResponse;
...
import static api.menu.MenuAcceptanceTest.메뉴_등록_되어있음;
import static api.menugroup.MenuGroupAcceptanceTest.메뉴그룹_등록되어있음;
import static api.order.OrderAcceptanceTest.주문_상태_변경요청함;
import static api.order.OrderAcceptanceTest.주문등록되어있음;
import static api.product.ProductAcceptanceTest.상품_등록되어_있음;
import static api.tablegroup.TableGroupAcceptanceTest.테이블_그룹화_되어있음;
import static api.menu.fixtures.MenuFixtures.메뉴등록요청;
import static api.menugroup.fixtures.MenuGroupFixtures.한마리메뉴그룹요청;
import static api.menu.fixtures.MenuProductFixtures.메뉴상품등록요청;
import static api.order.fixtures.OrderFixtures.식사중으로_변경요청;
import static api.order.fixtures.OrderFixtures.주문등록요청;
import static api.order.fixtures.OrderLineItemFixtures.주문정보_등록요청;
import static api.table.fixtures.OrderTableFixtures.*;
import static api.product.fixtures.ProductFixtures.양념치킨요청;
import static api.tablegroup.fixtures.TableGroupFixtures.그룹테이블_그룹요청;
