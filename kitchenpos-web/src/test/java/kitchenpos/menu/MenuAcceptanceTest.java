...
import static api.menu.MenuFixtures.후라이드두마리메뉴요청;
import static api.menu.MenuFixtures.후라이드반양념반메뉴요청;
import static api.menu.MenuProductFixtures.메뉴상품등록요청;
import static api.menugroup.MenuGroupFixtures.두마리메뉴그룹요청;
import static api.product.ProductFixtures.양념치킨요청;
import static api.product.ProductFixtures.후라이드요청;
