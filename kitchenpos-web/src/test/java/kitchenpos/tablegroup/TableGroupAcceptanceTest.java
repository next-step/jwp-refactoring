...
import kitchenpos.order.OrderAcceptanceTest;
...
public class TableGroupAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        MenuGroupResponse 한마리메뉴그룹 = MenuGroupAcceptanceTest.메뉴그룹_등록되어있음(한마리메뉴그룹요청());
    ...
    public void ungroupFail() {
        // given
        TableGroupResponse savedGroupTable = 테이블_그룹화_되어있음(그룹테이블_그룹요청(newArrayList(테이블_그룹요청(빈_테이블1_ID), 테이블_그룹요청(빈_테이블2_ID))));
        OrderAcceptanceTest.주문등록되어있음(주문등록요청(빈_테이블1_ID, Lists.newArrayList(주문정보_등록요청(메뉴_ID, 1L))));
