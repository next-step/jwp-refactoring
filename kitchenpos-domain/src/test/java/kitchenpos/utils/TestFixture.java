...
public class TestFixture {
	...
	//OrderLineItem
	public static final OrderLineItem 주문아이템_조리중_테이블11_후라이드_1개 = new OrderLineItem(1L, 메뉴_후라이드, 1);
	public static final OrderLineItem 주문아이템_조리중_테이블11_양념_1개 = new OrderLineItem(2L, 메뉴_양념치킨, 1);
	public static final OrderLineItem 주문아이템_식사중_테이블12_반반_2개 = new OrderLineItem(3L, 메뉴_반반치킨, 2);
	public static final OrderLineItem 주문아이템_계산완료_테이블13_통구이_1개 = new OrderLineItem(4L, 메뉴_통구이, 1);
	public static final OrderLineItem 주문아이템_계산완료_테이블13_간장_1개 = new OrderLineItem(5L, 메뉴_간장치킨, 1);
	public static final OrderLineItem 주문아이템_계산완료_테이블13_순살_1개 = new OrderLineItem(6L, 메뉴_순살치킨, 1);

	//Order
	public static final Order 주문_조리중_테이블11 = new Order.Builder(
		테이블_단체2_조리중_3명_11
		, Arrays.asList(주문아이템_조리중_테이블11_후라이드_1개, 주문아이템_조리중_테이블11_양념_1개))
		.id(1L)
		.orderedTime(LocalDateTime.of(2021, 1, 28, 12, 30))
		.build();
	public static final Order 주문_식사중_테이블12 = new Order.Builder(
		테이블_식사중_4명_12
		, Arrays.asList(주문아이템_식사중_테이블12_반반_2개))
		.id(2L)
		.orderStatus(OrderStatus.MEAL)
		.orderedTime(LocalDateTime.of(2021, 1, 28, 13, 30))
		.build();
	public static final Order 주문_계산완료_테이블13 = new Order.Builder(
	테이블_계산완료_5명_13
		, Arrays.asList(주문아이템_계산완료_테이블13_통구이_1개, 주문아이템_계산완료_테이블13_간장_1개, 주문아이템_계산완료_테이블13_순살_1개))
		.id(3L)
		.orderStatus(OrderStatus.COMPLETION)
		.orderedTime(LocalDateTime.of(2021, 1, 28, 14, 30))
		.build();
