...
class ProductAcceptanceTest extends AcceptanceTest {
    ...
    /**
     * when : 상품 정보를 등록하면 then : 정상적으로 등록이 되며(201 CREATED), ID가 설정되어 반환된다
     */
    ...
    /**
     * background given : 상품 2개가 저장되어있고 후라이드 : 17000원 양념 : 15000원 when : 상품 리스트를 조회했을때 then : 정상적으로
     * 조회가 된다.(200 OK)
     */
    @Test
    ...
    /**
     * given : 가격이 0이하인 상품 정보가 주어지고 when : 상품 등록을 할시 then : 에러가 발생한다
     */
    @Test
