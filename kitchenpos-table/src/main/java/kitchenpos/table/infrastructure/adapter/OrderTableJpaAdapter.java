...
import static kitchenpos.table.exceptions.TableExceptionCode.ORDER_TABLE_NOT_FOUND;
...
public class OrderTableJpaAdapter implements OrderTablePort {
    ...
    @Override
    public List<OrderTable> findAllByTableGroupIdIn(List<Long> tableGroupIds) {
        return orderTableJpaRepository.findAllByTableGroupIdIn(tableGroupIds);
    }
}
