...
import kitchenpos.table.tablegroup.application.TableGroupService;
...
public class TableGroupRestController {
    ...
    public ResponseEntity<TableGroup> create(@RequestBody final CreateTableGroupRequest request) {
