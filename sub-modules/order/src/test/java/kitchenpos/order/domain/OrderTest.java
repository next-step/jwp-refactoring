...
public class OrderTest {
    ...
    void createOrder() {
        ...
        // then
        assertThat(savedOrder.status()).isEqualTo(OrderStatus.COOKING);
    ...
    void updateOrderStatus() {
        ...
        // when
        savedOrder.updateStatus(OrderStatus.MEAL);
        // then
        assertThat(savedOrder.status()).isEqualTo(OrderStatus.MEAL);

        // when
        savedOrder.updateStatus(OrderStatus.COMPLETION);
        // then
        assertThat(savedOrder.status()).isEqualTo(OrderStatus.COMPLETION);
    }
