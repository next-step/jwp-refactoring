...
import static kitchenpos.table.fixture.OrderTableTestFixture.주문테이블_생성_요청;
import static kitchenpos.table.fixture.TableGroupTestFixture.*;

@DisplayName("테이블그룹(단체) 관련 인수 테스트")
public class TableGroupAcceptanceTest extends TableAcceptanceConfig {
    /**
