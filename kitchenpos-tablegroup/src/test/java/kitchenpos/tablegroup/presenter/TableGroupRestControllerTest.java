...
import kitchenpos.acceptence.TableRestControllerTest;
import kitchenpos.table.dto.TableRequest;
import kitchenpos.table.dto.TableResponse;
import kitchenpos.tablegroup.acceptence.AcceptanceSupport;
...
class TableGroupRestControllerTest extends AcceptanceSupport {
    ...
    public void setUp() {
        super.setUp();
        주문테이블_일번 = TableRestControllerTest.주문테이블을_생성한다(new TableRequest(5, true))
                .as(TableResponse.class);
        주문테이블_이번 = TableRestControllerTest.주문테이블을_생성한다(new TableRequest(9, true))
                .as(TableResponse.class);
