...
class TableGroupAcceptanceTest extends AcceptanceTest {
    ...
    void scenario() {
        ...
        // when
        ExtractableResponse<Response> response1 = 단체_지정_생성_요청(tableGroupRequest);
        // then
        단체_지정됨(response1);

        // when
        ExtractableResponse<Response> response2 = 단체_지정_해제_요청(tableGroupRequest.getId());
        // then
        단체_지정_해제됨(response2);
    }
    ...
    void ungroupTableGroupException() {
        ...
        ExtractableResponse<Response> response = 단체_지정_해제_요청(tableGroupRequest.getId());
