...
import kitchenpos.product.fixture.TestProductFactory;
...
class ProductRestControllerTest {
    ...
    void create() throws Exception {
        ...
        final ResultActions actions = mvc.perform(MockMvcRequestBuilders.post("/api/products")
    ...
    void list() throws Exception {
        ...
        final ResultActions actions = mvc.perform(MockMvcRequestBuilders.get("/api/products")
                        .accept(MediaType.APPLICATION_JSON_VALUE))
                .andDo(print());
