...
public class ProductTest {
    ...
    void 이름이_null이거나_빈값이면_상품을_생성할_수_없다(String name) {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> new Product(name, 18000))
                .withMessage(ErrorMessage.PRODUCT_REQUIRED_NAME.getMessage());
    }
    ...
    void 상품의_총_가격을_계산한다(int quantity, int price) {
        Product product = new Product("후라이드치킨", price);
