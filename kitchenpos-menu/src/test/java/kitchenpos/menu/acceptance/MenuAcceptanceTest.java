...
public class MenuAcceptanceTest extends AcceptanceTest {
    ...
    Stream<DynamicNode> menu() {
        Long 중식_ID = MenuGroupAcceptanceTest.메뉴그룹_등록됨("중식");
        Long 짜장면_ID = ProductAcceptanceTest.상품_등록됨("짜장면", 9000);
        Long 탕수육_ID = ProductAcceptanceTest.상품_등록됨("탕수육", 12000);
        return Stream.of(
    ...
    public static ExtractableResponse<Response> 메뉴_생성_요청(MenuRequest menuRequest) {
        return AcceptanceTest.post("/api/menus", menuRequest);
    }
