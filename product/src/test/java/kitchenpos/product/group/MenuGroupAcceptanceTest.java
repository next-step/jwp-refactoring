package kitchenpos.product.group;


import static kitchenpos.product.group.step.MenuGroupAcceptanceStep.메뉴_그룹_등록_되어_있음;
import static kitchenpos.product.group.step.MenuGroupAcceptanceStep.메뉴_그룹_등록_됨;
import static kitchenpos.product.group.step.MenuGroupAcceptanceStep.메뉴_그룹_등록_요청;
import static kitchenpos.product.group.step.MenuGroupAcceptanceStep.메뉴_그룹_목록_조회_됨;
import static kitchenpos.product.group.step.MenuGroupAcceptanceStep.메뉴_그룹_목록_조회_요청;
