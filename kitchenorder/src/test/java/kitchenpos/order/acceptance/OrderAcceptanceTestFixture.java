...
public class OrderAcceptanceTestFixture extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        세트 = MenuGroupAcceptanceTestFixture.메뉴_그룹_생성되어있음(new MenuGroupRequest("세트"));

        떡볶이 = ProductAcceptanceTestFixture.상품_생성_되어있음(new ProductRequest("떡볶이", BigDecimal.valueOf(4500)));
        튀김 = ProductAcceptanceTestFixture.상품_생성_되어있음(new ProductRequest("튀김", BigDecimal.valueOf(2500)));
        순대 = ProductAcceptanceTestFixture.상품_생성_되어있음(new ProductRequest("순대", BigDecimal.valueOf(4000)));
        ...
        떡튀순 = MenuAcceptanceTestFixture.메뉴_생성_되어있음(new MenuRequest("떡튀순", BigDecimal.valueOf(10000), 세트.getId(), 떡튀순_상품_목록));
        떡튀순_곱배기 = MenuAcceptanceTestFixture.메뉴_생성_되어있음(new MenuRequest("떡튀순_곱배기", BigDecimal.valueOf(10000), 세트.getId(), 떡튀순_곱배기_상품_목록));

        주문_테이블 = OrderTableAcceptanceTestFixture.주문_테이블_생성_되어있음(new OrderTableRequest(null, 0, false));
